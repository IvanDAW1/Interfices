...
int seleccionarCuentas(Cuenta cuentas[5]) {
    ...
    cout << "No se pudo encontrar el numero de la cuenta" << endl;
    cout << "Cuenta por defecto 0";
    return -1;
}
...
int main(int argc, char *argv[]) {
    ...
    int num = seleccionarCuentas(cuentas);
    if (num >= 0) {
        procesarIngreso(&cuentas[num]);
        mostrarCuentas(cuentas);
    }
